...
const DiscussionTopic = ({ topic }) => {
  return (
    <div className="bg-slate-900 border border-slate-800 p-8 w-full max-w-3xl relative overflow-hidden group">
      ...
      <div className="flex flex-col items-center space-y-4">
        ...
        <div className="flex items-center justify-center gap-6 text-center">
          <div className="hidden sm:block w-12 h-[1px] bg-slate-800" />
          <p className="text-xl sm:text-2xl font-mono font-bold text-slate-100 tracking-tighter uppercase leading-tight max-w-lg">
            {topic}
          </p>
          <div className="hidden sm:block w-12 h-[1px] bg-slate-800" />
        </div>
