          ...
          <div className="text-center p-8 max-w-md">
            ...
            <div className="flex justify-center items-center mt-6">
              <button
                ...
                className="bg-blue-500 hover:bg-blue-600 text-on-surface font-medium py-2 px-4 rounded flex items-center gap-2 transition-colors duration-200 shadow-sm"
              >
